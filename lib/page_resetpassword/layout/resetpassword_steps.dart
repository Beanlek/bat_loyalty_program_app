...
class ResetPasswordStepsPage extends StatefulWidget {
  const ResetPasswordStepsPage({super.key});

  static const routeName = '/reset_password_steps';

  @override
  State<ResetPasswordStepsPage> createState() => _ResetPasswordStepsPageState();
}

class _ResetPasswordStepsPageState extends State<ResetPasswordStepsPage> with MyComponents, ResetPasswordComponents{
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                SizedBox(height: 12,),
                                Text(Localizations.enter_security_phrase_and_image, style: Theme.of(context).textTheme.bodySmall, textAlign: TextAlign.center,),
                                SizedBox(height: 24,),

                                MyWidgets.MyTextField1(context, Localizations.security_phrase, securityPhraseController, onSubmit: (value) async {
                                  // setState(() {
                                  //   isLoading = true;
                                  // });
                            ...
                            MyWidgets.MyButton1(context, 150, Localizations.next,
                              () async { FloatingSnackBar(message: 'hehe', context: context);
                                // if (mainButtonActive) {
                                ...
                                //   });
                                // } else {
                                //   FloatingSnackBar(message: 'mainButtonActive = false', context: context);
                                // }
                              }
                            ),
                          ],
