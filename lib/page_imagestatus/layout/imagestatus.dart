...
class _ImageStatusPageState extends State<ImageStatusPage> with ImageStatusComponents, MyComponents {
  ...
  void initState() {
    super.initState();  
    print('ImageStatusPage initialized');
...
void dispose() { 
  ...
  Widget build(BuildContext context) {
    print('Building ImageStatusPage, launchLoading: $launchLoading');
    ...
    return PopScope(
      canPop: true,
        ...
        if (didPop){
         print('PopScope: About to pop with refresh true');
      if (context.mounted) {
        ImageStatusNotifier.refresh();
        print('Context is mounted, popping with refresh true');
